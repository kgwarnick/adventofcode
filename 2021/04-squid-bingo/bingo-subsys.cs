...
public class BingoSubsystem {
    ...
    public static void Run(List<int> numbers, List<BingoBoard> bblist) {
        ...
        int lastNumber;
        List<BingoBoard> winnerBoards = Play(bblist, numbers, out lastNumber);
    ...
    public static void Main() {
        ...
        Console.WriteLine("--- Aufgabe 1: Find the winning board ---");
    ...
    public static List<BingoBoard> Play(List<BingoBoard> boards, List<int> numberSequence, out int winningNumber) {
        ...
        foreach (int n in numberSequence) {
            ...
            foreach (BingoBoard b in boards) {
                if (b.nextNumber(n))  winners.Add(b);
            }
            if (winners.Count > 0) {
